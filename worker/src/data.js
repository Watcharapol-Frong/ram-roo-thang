...
//
// KV ยังใช้กับของที่เปลี่ยนตลอดและต้องหมดอายุเอง: RATE_LIMIT, CHAT_HISTORY_RAM
// (รายงานลานจอดย้ายไป D1 แล้วตั้งแต่ ADR 0005 เพื่อเก็บทุกรายงานไว้ถ่วงน้ำหนักตามเวลา)
